 ...
 * @date    June 21, 2016
 * @file    xorshift.h
 * @brief   The code for the xoroshiro128+ (as indicated below in comment 
 *          blocks) was written in 2016 by David Blackman and Sebastiano Vigna 
 *          (vigna@acm.org). This code was modified in 2016 by Aadyot Bhatnagar 
 *          to satisfy the conditions placed on a UnivornRandomNumberGenerator 
 *          for use with C++ STL random number generation functions. 
 */
