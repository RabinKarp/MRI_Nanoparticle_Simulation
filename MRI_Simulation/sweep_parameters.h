...
const int num_mnp_sizes = 1;                        // Number of nanoparticle sizes to sweep over
const double mnp_sizes[] = {0.1};                 // List of nanoparticle radii (um)

const int num_permeabilities = 1;                   // Number of permeabilities to sweep over
const double permeabilities[] = {0.01};             // List of permeabilities in micron per ms

const int num_conc = 1;                             // Number of concentrations to sweep over
const double concentrations[] = {1.0};             // List of MNP concentrations in mg / mL
